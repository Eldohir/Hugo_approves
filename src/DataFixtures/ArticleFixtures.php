...
class ArticleFixtures extends Fixture implements DependentFixtureInterface
{
    const ARTICLES = [
        ...
        ['Name' => 'Messi face au Real', 'Date' => "23/04/2017", 'Summary' => 'Messi inscrit le but de la victoire face au Real dans les dernières secondes', 'Category' => 'category_Grands moments de foot', 'Image' => 'https://imgresizer.eurosport.com/unsafe/1280x960/smart/filters:format(jpeg)/origin-imgresizer.eurosport.com/2017/04/23/2069027-43375747-2560-1440.jpg',],
        ...
        ['Name' => 'Chili', 'Date' => "Février 2011", 'Summary' => 'Un fils d\'immigré sur les terres de son père', 'Category' => 'category_Voyages', 'Image' => 'https://www.guidesulysse.com/images/destinations/iStock-1203728919.jpg',],
        ['Name' => 'Brésil', 'Date' => "Hiver 2020", 'Summary' => 'Les merveilles do Brasil juste avant le drame', 'Category' => 'category_Voyages', 'Image' => 'https://www.costacroisieres.fr/content/dam/costa/inventory-assets/ports/RIO/rio-rio-de-janeiro-port-1.jpg',],
